...
class BookImgView:
    ...
    def get_book_img_by_filename(filename: str, controller: BookImgController) -> Response:
    ...
    @jwt_required()
    def delete_book_img(id_book: str, id_img: str, controller: BookImgController) -> Response:
    ...
    @jwt_required()
    def update_book_img(id_book: str, id_img: str, controller: BookImgController) -> Response:
    ...
    @jwt_required()
    def add_book_img(id_book: str, controller: BookImgController) -> Response:
        input_dto = BookImgInputDTO(**Request.get_files())
