...
from .. import IBookKeywordService


@inject
class BookKeywordService(IBookKeywordService):
    def __init__(
        self, book_repository: IBookRepository, book_keyword_repository: IBookKeywordRepository
    ) -> None:
